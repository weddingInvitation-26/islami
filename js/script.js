document.addEventListener('DOMContentLoaded', () => {
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#2D8A4E', '#5CB878', '#D4AF37', '#1A3A2A', '#F8FAF8'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    'linear-gradient(135deg, #2D8A4E, #5CB878)',
    'linear-gradient(135deg, #1A3A2A, #2D8A4E)',
    'linear-gradient(135deg, #D4AF37, #F0D68A)',
    'linear-gradient(135deg, #5CB878, #F8FAF8)',
    'linear-gradient(135deg, #1A3A2A, #D4AF37)',
    'linear-gradient(135deg, #2D8A4E, #1A3A2A)'
  ];
